...
Some of the ideas I came across challenged the idea that Autism was a disorder. [Autism and Computing](http://www.autismandcomputing.org.uk) (A&C) is "a non-profit group, whose aim is to explore ways of minimizing the effects of a disabling society on people disposed to [Monotropism](http://www.autismandcomputing.org.uk/hypothesis.en.html)".
...
>"Autism is classified as a neurodevelopmental disorder that manifests itself in markedly abnormal social interaction, communication ability, patterns of interests, and patterns of behavior." -[Wikipedia Entry](http://en.wikipedia.org/wiki/Autism)

[Autism and Computing](http://www.autismandcomputing.org.uk) claim instead that "the [Autistic spectrum of behaviours](http://en.wikipedia.org/wiki/Autism#Autism_as_a_spectrum_disorder) is evidence of one extreme of the normal distribution of types of mind that we would expect to find, given the environment in which the human race has evolved".
...
<br/>**Evolutionary Advantage:** Promotes physical survival in a harsh environment through focused attention.

* **Polytropic** tendency: Many interests less highly aroused; 
<br/>**Evolutionary Advantage:** Promotes social interaction, and the shifting of attention.
...
If we continue with the optical metaphor (focus), a Montropic mind studies the world through an _interest spotlight_, or an _attention tunnel_. The Polytropic mind does its share of problem-solving by _multi-tasking_; optically, think fly eyes. ;)
...
>"[The Monotropic mind is] optimised for searching for sustenance in a dangerous environment in which resources are scarce. The _attention tunnel_ which links the unarmed hunter to the prey must be optimised for the immediate high gain high risk opportunity. It must have a propensity to accept what is seen, _even when this contradicts what was formerly thought_ to be known. "

>"Such a mind must have a propensity for actual rather than literal information. Such a mind seems to have the will to error, but is in fact the only sort of mind capable of discoveries that go beyond the known and transform situations. 
_Only error making leads to metamorphic discovery._"

Is it any surprise that a large number of scientists, mathematicians, and engineers are said to be "higher-functioning autistics", ([Asperger's Syndrome](http://en.wikipedia.org/wiki/Autism#Asperger.27s_and_Kanner.27s_syndrome))?

####Immunity to Mind Viruses

>A Meme consists of a self-propagating unit of cultural evolution having a resemblance to the gene (the unit of genetics). Examples might include thoughts, ideas, theories, practices, habits, songs, dances and moods in addition to concepts such as race. -[Wikipedia Entry](http://en.wikipedia.org/wiki/Meme)

In [Andrew Walker](http://www.guardian.co.uk/Archive/Article/0,4273,3946883,00.html)'s paper [What is the point of Autism?](http://www.autismandcomputing.org.uk/walker2.en.html) he hypothesizes that the Monotropic mind is immune to these mind viruses (Memes). He reasons that "Autistic phenotypes do not [communicate by means of memes], because they perceive their universe in terms of the strictly physical and thus memes are cognitively 'invisible'."

If this is true, the Monotropic mind lost its evolutionary advantage as we formed ever larger social units. Beginning with large packs of humans, and  later with villages, and cities, the Monotropic _attention tunnel_ proved too narrow to process all the nuances of social interactions: words strung into sentences; audible stress, accent, and tone; body language; situation specific cultural rules; &c. Thus, the Monotropic mind was "shut-out" of the social discourse, unable to process the Memes on which our societies/cultures are based.

####Flow: Moments of Monotropy

[What I call "the zone"](http://stungeye.com/archives/2004/02/blunt_sharpie_c.php), and others label [Flow](http://en.wikipedia.org/wiki/Flow_(psychology\)), is well known and much sought-after in the coding and artistic communities.

>"When you are in the flow, you concentrate only on what you are doing and you hold all the required details in your head, in the short and middle term memory. Because there are no disturbances inside your own head, all the details are readily accessible to the brain and the brain in general works like a well-oiled machine, the work progresses excellently and working is a pleasure." -[Cringe from crossing a concentrating coder](http://liw.iki.fi/liw/texts/flow.en.html).
...
* _Coding_: constraint through language, logic; 
* _Visual Arts_: constraint through media, form, colour; 
* _Composing_: constraint through harmony, melody, rhythm. 
...
####Links
* [In My Language](http://www.youtube.com/watch?v=JnylM1hI2jc) - A view of Autistic language/interaction. [video]
* [Mind as a Dynamical System: Implications for Autism](http://www.autismandcomputing.org.uk/mind.en.html)
* [What is the point of autism?](http://www.autismandcomputing.org.uk/walker2.en.html)
* [Wikipedia Attention](http://en.wikipedia.org/wiki/Attention)
* [Flow in Games](http://intihuatani.usc.edu/cloud/flowing/)
* [Thinking in Pictures](http://www.grandin.com/inc/visual.thinking.html)
* [Inner Savant](http://www.discover.com/issues/feb-02/features/featsavant/)
* [Play Attention](http://www.playattention.com) - adhd video game therapy
* [Turning off self-awareness](http://www.newscientist.com/article.ns?id=dn9019&feedId=online-news_rss20)
* [Autism symptoms reversed in lab](http://news.bbc.co.uk/2/hi/health/6245742.stm)
