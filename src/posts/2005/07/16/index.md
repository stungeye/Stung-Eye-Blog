...
Bono dedicated one song to <a href="http://en.wikipedia.org/wiki/Theo_van_Gogh_(film_director)">Theo Van Gogh</a> and <a href="http://en.wikipedia.org/wiki/Pim_Fortuyn">Pim Fortuyn</a>, and later called on the Dutch to lead the world in terms of Christian, Muslim and Jewish coexistence.

<em>(Note that the Pim Fortuyn article on Wikipedia, like many others that mention Islam, is marked with a neutrality dispute.)</em>
